...
module.exports = {
    getTSV: async function () {
        var url = 'https://lscluster.hockeytech.com/feed/index.php?feed=modulekit&view=schedule&team=-1&season=67&month=-1&location=homeaway&key=e828f89b243dc43f&client_code=ushl&site_id=0&league_id=1&division_id=-1&lang=en&fmt=json';
        ...
        games.forEach(function (gameObject, i) {
            ...
            rowObjects.push({
                ...
                source: 'https://lscluster.hockeytech.com/game_reports/official-game-report.php?client_code=ushl&game_id=' + games[i].game_id + '&lang_id=1'
            });
        });
